...
Another technique is to **group** bits into pairs: given $p$ the probability of a bit to be $1$, and $1-p$ the probability of a bit to be $0$, we can group bits into pairs, and then apply the following operation:
